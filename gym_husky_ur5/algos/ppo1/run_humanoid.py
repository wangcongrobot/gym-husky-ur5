# This is from openai baselines ppo1 run_humanoid.py

import os
from baselines.common.cmd_util import make_mujoco_env, mujoco_arg_parser
from baselines.common.common import tf_util as U
...
def train(num_timesteps, seed, model_path=None):
    ...
    # these are good enough to make humanoid walk, but whether those are an absolute best or not is not certain
...
def main():
    ...
    if not args.play:
        ...
        env = make_mujoco_env('UR5Gripper-v0', seed=0)
